...
const HomeServicesPage = () => (
  <div className="flex flex-col items-center justify-center min-h-[70vh] bg-gradient-to-b from-white to-gray-50">
    <div className="bg-white shadow-lg rounded-xl px-8 py-12 flex flex-col items-center max-w-lg w-full border border-gray-100">
      <div className="bg-primary-100 rounded-full p-4 mb-4">
        <Wrench className="w-12 h-12 text-primary-600" />
      </div>
      <h1 className="text-3xl font-extrabold mb-2 text-primary-700 text-center">Home Services</h1>
      <p className="text-lg text-gray-600 text-center mb-2">We are coming soon!</p>
      <p className="text-base text-gray-500 text-center">Please check back later for professional home services and exciting new features.</p>
    </div>
  </div>
);
...
//       {/* Success Message */}
//       {showSuccessMessage && (
//         <div className="fixed top-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg z-50 flex items-center">
